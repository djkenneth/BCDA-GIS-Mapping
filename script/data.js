...
const mapMarkers = [
  {
    ...
    subcategoryConfigs: {
      "bir-headquarters": {
        title: "BIR Headquarters",
        type: "Government Infrastructure",
        className: "data-center-bg",
        icon: "fas fa-desktop",
      },
      "dof-regional-office": {
        title: "DOF Regional Office",
        type: "Government Infrastructure",
        className: "data-center-bg",
        icon: "fas fa-desktop",
      },
      "bir-reqional-office": {
        title: "BIR Regional Office",
        type: "Government Infrastructure",
        className: "data-center-bg",
        icon: "fas fa-desktop",
      },
...

  {
    ...
    subcategoryConfigs: {
      "other-hazards": {
        title: "Other Environmental Hazards",

...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function openCamera() {
    ...
    if (navigator.mediaDevices && navigator.mediaDevices.getUserMedia) {
      ...
      alert(
        "Your device doesn't support camera access, or you've denied permission."
      );
    }
  }
  ...
  function handleSubmit() {
    ...
    if (issueDateReported)
      formData.append("issueDateReported", issueDateReported.value);
    ...
    if (issueDescription)
      formData.append("issueDescription", issueDescription.value);
  ...
  if (issueReportButton) {
    ...
    console.warn(
      "Issue report button not found - trying alternative selectors"
    );
    ...
    buttons.forEach((btn) => {
      ...
      if (
        (text.includes("report") && text.includes("issue")) ||

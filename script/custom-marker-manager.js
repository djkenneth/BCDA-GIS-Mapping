...
/**
 * Map subcategory names to marker types
 * This allows us to determine which marker set to use based on the subcategory
 */
...
function getMarkerIcon(subcategory, status) {
  ...
  const markerType = subcategoryToMarkerType[subcategory] || "default";
